...
# Autor        :  4lph4shell (https://github.com/4lph4shell)
# Description  :  Powerful asynchronus IPv4 Network Scanner
# Repository   :  https://github.com/4lph4shell/IPv4NetworkScanner
###############################################################################################################
...
echo -e "$AUTOCLICKER_TEXT"
    ...
    .LINK
    https://github.com/4lph4shell/IPv4NetworkScanner/blob/main/README.md
#>
